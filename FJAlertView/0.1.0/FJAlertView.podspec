#
# Be sure to run `pod lib lint FJAlertView.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  # s.description      = 'a custom AlertView like UIAlertViewController'
  ...
  # s.resource_bundles = {
  #   'FJAlertView' => ['FJAlertView/Assets/*.png']
  # }
